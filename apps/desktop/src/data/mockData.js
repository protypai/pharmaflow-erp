...
export const salesmen = ['Ramesh Kumar', 'Suresh Patil', 'Mahesh Joshi', 'Deepak Sharma'];
export const areas = ['Dadar', 'Parel', 'Kurla', 'Bandra', 'Ghatkopar', 'Andheri', 'Borivali', 'Thane'];
