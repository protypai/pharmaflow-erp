...
function Header({ collapsed, onToggle, pathname }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("header", { className: "app-header", children: [(0, jsx_runtime_1.jsx)("button", { className: "header-icon-btn", onClick: onToggle, id: "sidebar-toggle", children: collapsed ? (0, jsx_runtime_1.jsx)(lucide_react_1.Menu, { size: 18 }) : (0, jsx_runtime_1.jsx)(lucide_react_1.Menu, { size: 18 }) }), (0, jsx_runtime_1.jsxs)("div", { className: "header-breadcrumb", children: [(0, jsx_runtime_1.jsx)("div", { className: "header-title", children: pageInfo.title }), pageInfo.sub && (0, jsx_runtime_1.jsx)("div", { className: "header-sub", children: pageInfo.sub })] }), (0, jsx_runtime_1.jsxs)("div", { className: "header-search", onClick: () => { setSearchOpen(true); setTimeout(() => searchRef.current?.focus(), 50); }, id: "global-search-trigger", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Search, { size: 14, color: "var(--text-muted)" }), (0, jsx_runtime_1.jsx)("span", { className: "header-search-text", children: "Search medicines, customers\u2026" }), (0, jsx_runtime_1.jsx)("span", { className: "header-search-kbd", children: "Ctrl K" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "header-actions", children: [(0, jsx_runtime_1.jsxs)("button", { className: "header-icon-btn", id: "notifications-btn", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Bell, { size: 17 }), (0, jsx_runtime_1.jsx)("span", { className: "header-badge" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { position: 'relative' }, children: [(0, jsx_runtime_1.jsx)("div", { className: "header-avatar", onClick: () => setProfileOpen(!profileOpen), id: "profile-avatar", children: "SM" }), profileOpen && ((0, jsx_runtime_1.jsxs)("div", { style: {
