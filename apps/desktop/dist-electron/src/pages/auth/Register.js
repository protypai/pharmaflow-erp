    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            background: 'linear-gradient(135deg, #F0F7FF 0%, #EFF6FF 40%, #F1F5F9 100%)',
                    ...
                    overflowY: 'auto',
                            ...
                            }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.CheckCircle, { size: 40, color: "#16A34A" }), (0, jsx_runtime_1.jsx)("h3", { style: { fontSize: '1.1rem', fontWeight: 700, color: '#15803D' }, children: "Registration Submitted" }), (0, jsx_runtime_1.jsx)("p", { style: { fontSize: '0.85rem', color: '#166534', lineHeight: 1.5 }, children: successMsg }), (0, jsx_runtime_1.jsx)("button", { className: "btn btn-primary", onClick: () => navigate('/login'), style: { marginTop: '0.5rem' }, children: "Return to Sign In" })] })) : ((0, jsx_runtime_1.jsxs)("form", { onSubmit: handleRegister, style: { display: 'flex', flexDirection: 'column', gap: '0.875rem' }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Company Name *" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Building, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "companyName", placeholder: "e.g. Apex Pharma Distributors", value: formData.companyName, onChange: handleChange, required: true })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: '0.75rem' }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Short Name" }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "shortName", placeholder: "e.g. Apex Pharma", value: formData.shortName, onChange: handleChange })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "GSTIN" }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "gstin", placeholder: "27AAAAA0000A1Z5", value: formData.gstin, onChange: handleChange })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Full Name *" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.User, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "name", placeholder: "Your Full Name", value: formData.name, onChange: handleChange, required: true })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Email Address *" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Mail, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "email", name: "email", placeholder: "admin@yourpharmacy.com", value: formData.email, onChange: handleChange, required: true })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Password *" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Lock, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: showPass ? 'text' : 'password', name: "password", placeholder: "Create a strong password", value: formData.password, onChange: handleChange, style: { paddingRight: '2.5rem' }, required: true }), (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setShowPass(!showPass), style: {
                                                        position: 'absolute', right: '0.625rem',
                                                        background: 'none', border: 'none', cursor: 'pointer',
                                                        color: 'var(--text-muted)', display: 'flex', alignItems: 'center',
                                                    }, children: showPass ? (0, jsx_runtime_1.jsx)(lucide_react_1.EyeOff, { size: 15 }) : (0, jsx_runtime_1.jsx)(lucide_react_1.Eye, { size: 15 }) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: '0.75rem' }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "Phone" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Phone, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "phone", placeholder: "9876543210", value: formData.phone, onChange: handleChange })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "form-group", style: { flex: 1 }, children: [(0, jsx_runtime_1.jsx)("label", { className: "form-label", children: "City" }), (0, jsx_runtime_1.jsxs)("div", { className: "input-wrapper", children: [(0, jsx_runtime_1.jsx)("span", { className: "input-icon", children: (0, jsx_runtime_1.jsx)(lucide_react_1.MapPin, { size: 15 }) }), (0, jsx_runtime_1.jsx)("input", { className: "form-input", type: "text", name: "city", placeholder: "City", value: formData.city, onChange: handleChange })] })] })] }), error && ((0, jsx_runtime_1.jsx)("div", { style: {
