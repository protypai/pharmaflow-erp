...
function Login() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            background: 'linear-gradient(135deg, #F0F7FF 0%, #EFF6FF 40%, #F1F5F9 100%)',
                ...
                }, children: (0, jsx_runtime_1.jsxs)("div", { style: { width: '100%', maxWidth: 380 }, children: [hasUpdate && ((0, jsx_runtime_1.jsxs)("div", { style: {
                                background: '#EFF6FF', border: '1px solid #BFDBFE',
                                borderRadius: '8px', padding: '0.75rem 1rem',
                                marginBottom: '1.5rem', display: 'flex', alignItems: 'center',
                                justifyContent: 'space-between', gap: '0.75rem',
                            }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', gap: '0.5rem' }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Sparkles, { size: 16, color: "#2563EB" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: '0.8rem', fontWeight: 600, color: '#1E40AF' }, children: "Update Available" }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: '0.72rem', color: '#3B82F6' }, children: "A new version is ready to install" })] })] }), (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "btn btn-primary btn-sm", onClick: () => {
