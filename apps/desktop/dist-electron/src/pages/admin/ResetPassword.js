...
function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem('adminToken');
            const res = await fetch(`${api_1.API_BASE_URL}/api/v1/admin/reset-password`, {
                method: 'POST',
                headers: {
